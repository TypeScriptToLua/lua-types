...
interface LuaMetatable<T> {
   ...
   */
  __concat?(self: T, operand: any): any;
   ...
   */
  __eq?(self: T, operand: any): boolean;
   ...
   */
  __lt?(self: T, operand: any): boolean;
   ...
   */
  __le?(self: T, operand: any): boolean;

  /**
   * The indexing access table[key]. This event happens when table is not a table or when key is not present in table. The metamethod is looked up in table.
   *
   ...
   */
  __index?: T | ((self: T, key: any, value: any) => any);
   ...
   */
  __newindex?: T | ((self: T, key: any, value: any) => void);
